---
name: review
description: "Active-recall quiz from a wiki concept page. Use when the user wants to self-test or review a concept."
---

# review (Claude Code pointer)

This is a thin pointer, not a second copy. The actual instructions for this
skill live in `.agents/skills/review/SKILL.md` -- read that file now and
follow it exactly.
...
If `.agents/skills/review/SKILL.md` doesn't exist, stop and say so rather
