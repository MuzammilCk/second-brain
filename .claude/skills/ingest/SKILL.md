---
name: ingest
description: "Ingest new material from raw exports into the wiki. Use when the user has dropped new Claude or ChatGPT exports or notes to process into the vault."
---

# ingest (Claude Code pointer)

This is a thin pointer, not a second copy. The actual instructions for this
skill live in `.agents/skills/ingest/SKILL.md` -- read that file now and
follow it exactly.
...
If `.agents/skills/ingest/SKILL.md` doesn't exist, stop and say so rather
