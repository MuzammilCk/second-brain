---
name: decide
description: "Record an architecture or approach decision in a project's decision log. Use when the user makes or wants to record a technical decision for one of their projects."
---

# decide (Claude Code pointer)

This is a thin pointer, not a second copy. The actual instructions for this
skill live in `.agents/skills/decide/SKILL.md` -- read that file now and
follow it exactly.
...
If `.agents/skills/decide/SKILL.md` doesn't exist, stop and say so rather
