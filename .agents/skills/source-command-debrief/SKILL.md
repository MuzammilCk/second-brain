---
name: "source-command-debrief"
description: "Evening debrief — capture the day's signal into the log, propose decisions & priority edits"
---

# source-command-debrief

Use this skill when the user asks to run the source command `debrief`.
...
2. If arguments are empty, ask 3–4 short questions ONE AT A TIME (wait for each answer):
   ...
   If arguments are provided, treat them as the full summary — skip the questions.
