...
Index of active, paused, and shipped engineering projects in the vault.
...
- **[[invoice-studio|AI Invoice Studio]]**: Enterprise-grade voice billing app (React 19/Express/Ollama Qwen3/faster-whisper) migrating to local offline-first inference.
...
1. `wiki/projects/<slug>.md` — Project Overview.
2. `wiki/projects/<slug>-decisions.md` — Append-only Decision Log (see [[projects|Project Pages Guide]] for schema rules).
