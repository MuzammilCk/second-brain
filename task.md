...
| 2026-08-18 | Scaffold restored | `.claude/` scaffold (17 files) had been deleted in the working tree but intact at HEAD — restored all from HEAD (uncommitted deletions only; reflog confirms no checkout/reset/stash). No task IDs changed status: T-5.1b, T-7.4/7.5/7.6, T-8.1, T-9.1 remain genuine 🧍/⬜ user gates. SkillOpt-Sleep audit ([[wiki/concepts/skillopt]]) co-occurred but is orthogonal to the vault commands. |
